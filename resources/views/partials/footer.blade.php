        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 col-md-10">
                    <div class="footer-top">
                        ...
                        <a href="mailto:info@examplegmail.com" id="celebrateBtn" class="mail-area">info@examplegmail.com</a>
                    </div>
                </div>
            </div>
            <div class="footer-menu-wrap">
                <div class="row gy-5">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-4 d-flex justify-content-lg-center">
                        <div class="footer-widget">
                            ...
                            <ul class="widget-list">
                                ...
                                <li><a href="portfolio-classic.html">My Portfolio</a></li>
                                <li><a href="portfolio.html">News & Insight</a></li>
