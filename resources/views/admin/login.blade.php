...
<head>
        ...
        <meta charset="utf-8" />
        <title>Login | Portfolio - Admin & Dashboard</title>
        ...
        <!-- Layout Js -->
        <script src="{{asset ('asset_admin/js/layout.js')}}"></script>
        <!-- Bootstrap Css -->
        <link href="{{asset ('asset_admin/css/bootstrap.min.css')}}" id="bootstrap-style" rel="stylesheet" type="text/css" />
        <!-- Icons Css -->
        <link href="{{asset ('asset_admin/css/icons.min.css')}}" rel="stylesheet" type="text/css" />
        <!-- App Css-->
        <link href="{{asset ('asset_admin/css/app.min.css')}}" id="app-style" rel="stylesheet" type="text/css" />
                                ...
                                <div class="d-flex flex-column h-100 py-0 py-xl-3">
                                    <div class="text-center mb-4">
                                        <a href="index.html" class="">
                                            <img src="{{asset ('asset_admin/images/logo-dark.png')}}" alt="" height="22" class="auth-logo logo-dark mx-auto">
                                            <img src="{{asset ('asset_admin/images/logo-light.png')}}" alt="" height="22" class="auth-logo logo-light mx-auto">
                                        </a>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="p-lg-5 p-4">
                                                        <div>
                                                            ...
                                                            <form action=""  id="login_form" class="auth-input">
                                                                @csrf
                                                                <div class="mb-2">
                                                        ...
                                                        <div class="mt-4 text-center">
                                                            <p class="mb-0">Don't have an account ? <a href="{{ route('register.form') }}" class="fw-medium text-primary"> Register </a> </p>
                                                        </div>
                                                    </div>
                                                </div>  
                                        </div>
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Tocly. Crafted with <i class="mdi mdi-heart text-danger"></i> by Aman Yadav</p>
                                    </div>
                                </div>
                            </div>
                        </div>
